	...
	class ZoriBasic
	{
		...
		public function getFooter()
		{
      	...
      	global $SystemSettings;
            ...
            <footer class='clearfix footer_fixed' style='position:absolute; bottom:0px; left:0px; width:100%; margin-left:0px;'> 
               <div class='pull-left'><p style='margin:8px 0px 0px 0px;'>".$SystemSettings[CopyrightSymbolYear].$SystemSettings[Copyright]." </p></div>
               <div class='pull-right'> <img src='".$SystemSettings[ProjectLogoPic]."' height='35px;' />  </div>
               <div class='clearfix'></div>
            </footer>
			";
			return $this->FOOTER;
      ...
      public function Message($text=null)
      {
         ...
         if($this->Message->Text != ""){
            return "<div class='".$this->Message->class."' role='alert'>
