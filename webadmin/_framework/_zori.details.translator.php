...
class ZoriDetailsTranslator extends ZoriDetails
{
   private static $Languages = array("EN", "AF");
   public $Language;
   public $hideOtherLanguage = true;
   ...
   public function AssimulateTable($table, $ID, $altEntityHeadingField="")
   {
      ...
      while($row = $this->dbInfo->fetch())
      {
         ...
         $this->Fields[$row->COLUMN_NAME]->Label = ZoriDetailsTranslator::cleanColumnName($row->COLUMN_NAME);
