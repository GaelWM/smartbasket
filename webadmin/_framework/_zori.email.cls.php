...
# 20131126 - UNLIKELY EVENT OF DUPLICATE UNIQUE ID'S BEING GENERATED - PJ
      $edb = new ZoriDatabase("tblEmail", 0, array("EmailID"),$blnDebug);
...
//26-11-2015 ca commented sending emails
...
$result = true;
   ...
   {
      $edb = new ZoriDatabase("tblEmailTemplate", 0, array("EmailTemplateID"),$blnDebug);
      if($this->warnings)
   ...
   public function SendFromDatabase($EmailID, $To="")
   {
      global $SystemSettings;
      $eol = $this->eol;
      $edb = new ZoriDatabase("tblEmail", $EmailID, array("EmailID"),$blnDebug);
...
function GetTemplate($TemplateID)
{
   ...
   if($Action == "Test")
   {
$nemoEmail = new ZoriEmail("exiledbandit@gmail.com" , "" , 0);
