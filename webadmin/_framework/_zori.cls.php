    ...
    public $SystemSettings = array();
      ...
      public function getHeader()
      {
         ...
         $header = "
            <div class='nav_menu'>
               <nav>
                 <div style='position:relative; float:left; width:40px !important; padding-top:10px;' class='nav toggle'> 
                 <a id='menu_toggle' href='#' onclick='jsHideMenu();'><i class='fa fa-bars'></i></a>  </div>
                 ...
                 <ul class='nav navbar-nav navbar-right'>
                   <li class=''>
                     ...
                     <ul class='dropdown-menu dropdown-usermenu pull-right'>
                       <li><a href='my.profile.php'><i class='fa fa-user'></i>$lblProfile</a></li>
                       <li><a href='faq.console.php'><i class='fa fa-info-circle'></i>$lblHelp</a></li>
		...
		public function Content($html)
      {
		...
		protected function iniToolbar()
   	{
         ...
         $this->Buttons[btnSave]->Control->onclick = "return jsZoriValidateSave();";
