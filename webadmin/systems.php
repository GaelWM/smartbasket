...
//DEV REPO
   ...
   $DATABASE_SETTINGS["localhost"]->database = "smartbasket";
   $DATABASE_SETTINGS["localhost"]->sessionpath = $_SERVER['DOCUMENT_ROOT']."/smartbasket/webadmin/SESSION/";

// //DEV QA
//    $DATABASE_SETTINGS["localhost"]->hostname = "localhost";
//    $DATABASE_SETTINGS["localhost"]->username = "gael_smartbasket";
//    $DATABASE_SETTINGS["localhost"]->password = "K1nsh@s@";
//    $DATABASE_SETTINGS["localhost"]->database = "smartbasket";
//    $DATABASE_SETTINGS["localhost"]->sessionpath = $_SERVER['DOCUMENT_ROOT']."/smartbasket/webadmin/SESSION/";
...
//LIVE PROD
   ...
   // $DATABASE_SETTINGS["www.live.co.za?/"]->sessionpath = $_SERVER['DOCUMENT_ROOT']."/smartbasket/webadmin/SESSION/";
   ...
   global $xdb, $HTTP, $MYSQLI, $db, $DATABASE_SETTINGS,$SystemSettings;
